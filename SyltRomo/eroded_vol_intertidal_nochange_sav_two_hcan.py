...
#-----INPUT-----------------------------------------------------------------
#rname = ['srm004_2010','srm005_2010','srm006_2010','srm007_2010','srm008_2010','srm009_2010']
#labels=['0.48','0.2','0.8','0.48','0.2','0.8']
#figname = "dragC"
...
#rname = ['srm001_2015','srm005_2015','srm008_2015']
#labels=['no seagrass','static seagrass','variable seagrass']
#figname = "srm1-5-8_2015"

#savref = 'srm008_2015'

#rname = ['srm001_2011','srm_settling_001','srm_settling_002','srm_settling_003','srm_settling_004']
#labels=['srm001','settling 1','settling 2','settling 3','settling 4']
...
#rname = ['srm020_2015','srm021_2015','srm022_2015','srm023_2015_','srm024_2015','srm025_2015']
#labels = ['no sg','stat sg','var sg','var sg + w','var sg + rs','stat sg + rs']
year = '2015'
...
savepat = "/work/gg0877/g260204/sim_data/SR5yr/plots/plots/" + figname + '/'
#savref = 'srm007_2010'
hcanlim1 = 0.1
hcanlim2 = 0.02
mean_hw = 0.9 #m
...
#volume change only inside basin & inside tidal range
iit1 = np.where(d_el <mean_lw)
iit2 = np.where(d_el > mean_hw)
...
h5pypath= '/work/gg0877/g260204/data/pickle_files/' + figname + '_intertidal_' + str(hcanlim1) + '_' + str(hcanlim2) + '.hdf5'
...
#    axs[1].plot(time_con, vol_con_no,linewidth=5,label = labels[count] + '; '+str(hcanlim2) + ' m >= canh',color=caolors[count])
...
axs[0].set_xticks([])
plt.tight_layout()
plt.savefig(savepat + "eroded_vol_intertidal_sav_hcan_subplot_"+ str(hcanlim1) +'_two_' + figname +'.pdf',format='pdf' )
