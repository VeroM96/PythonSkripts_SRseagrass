...
#normalize standart deviation for taylor plotting
def plot_elev_multi(spat,rname_all,labels,plot_path, grid, obspath,shifts):
    ...
    for i in range(0,len(rname_all)):
        ...
        for peg in pegnames:
            ...
            taylor.at[peg,'stds']=stats['sdev'][1]/stats['sdev'][0] #normalize
            taylor.at[peg,'rmss']=stats['crmsd'][1]
            taylor.at[peg,'cors']=stats['ccoef'][1]
            taylor.at[peg,'stds_obs']= stats['sdev'][0]
    
        df2 = pd.DataFrame({'stds':1,'rmss':stats['crmsd'][0],'cors':stats['ccoef'][0]},index=['obs']) #origin of stds is 1
    ...
    nametay = plot_path + 'taylor_elev_norm.png'
